...
namespace EFCoreCinemaAPI.Migrations
{
    ...
    [Migration("20250615042608_InheritanceByType")]
    partial class InheritanceByType
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EFCoreCinemaAPI.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amount = 9.99m,
                            TransactionDate = new DateTime(2025, 6, 13, 22, 26, 8, 408, DateTimeKind.Local).AddTicks(6435),
                            Type = 0
                        },
                        new
                        {
                            Id = 2,
                            Amount = 19.99m,
                            TransactionDate = new DateTime(2025, 6, 14, 12, 26, 8, 408, DateTimeKind.Local).AddTicks(6462),
                            Type = 0
                        });
                });
            ...
            modelBuilder.Entity("EFCoreCinemaAPI.Models.CardPay", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 5,
                            Amount = 79.99m,
                            TransactionDate = new DateTime(2025, 6, 12, 22, 26, 8, 399, DateTimeKind.Local).AddTicks(4430),
                            Type = 1,
                            Digits = "1234"
                        },
                        new
                        {
                            Id = 6,
                            Amount = 29.99m,
                            TransactionDate = new DateTime(2025, 6, 14, 19, 26, 8, 399, DateTimeKind.Local).AddTicks(4448),
                            Type = 1,
                            Digits = "5678"
                        });
                });
            ...
            modelBuilder.Entity("EFCoreCinemaAPI.Models.PaypalPay", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 3,
                            Amount = 99.99m,
                            TransactionDate = new DateTime(2025, 6, 13, 22, 26, 8, 409, DateTimeKind.Local).AddTicks(526),
                            Type = 2,
                        ...
                        new
                        {
                            Id = 4,
                            Amount = 49.99m,
                            TransactionDate = new DateTime(2025, 6, 14, 17, 26, 8, 409, DateTimeKind.Local).AddTicks(537),
                            Type = 2,
                            Email = "leomarqz@gmail.com"
                        });
                });
