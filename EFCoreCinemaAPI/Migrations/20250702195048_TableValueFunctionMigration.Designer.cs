...
namespace EFCoreCinemaAPI.Migrations
{
    ...
    [Migration("20250702195048_TableValueFunctionMigration")]
    partial class TableValueFunctionMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EFCoreCinemaAPI.Models.Invoice", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            TransactionDate = new DateTime(2025, 7, 2, 13, 50, 47, 617, DateTimeKind.Local).AddTicks(434)
                        });
                });
            ...
            modelBuilder.Entity("EFCoreCinemaAPI.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amount = 9.99m,
                            TransactionDate = new DateTime(2025, 7, 1, 13, 50, 47, 629, DateTimeKind.Local).AddTicks(4990),
                            Type = 0
                        },
                        new
                        {
                            Id = 2,
                            Amount = 19.99m,
                            TransactionDate = new DateTime(2025, 7, 2, 3, 50, 47, 629, DateTimeKind.Local).AddTicks(5014),
                            Type = 0
                        });
                });
            ...
            modelBuilder.Entity("EFCoreCinemaAPI.Models.CardPay", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 5,
                            Amount = 79.99m,
                            TransactionDate = new DateTime(2025, 6, 30, 13, 50, 47, 619, DateTimeKind.Local).AddTicks(5650),
                            Type = 1,
                            Digits = "1234"
                        },
                        new
                        {
                            Id = 6,
                            Amount = 29.99m,
                            TransactionDate = new DateTime(2025, 7, 2, 10, 50, 47, 619, DateTimeKind.Local).AddTicks(5666),
                            Type = 1,
                            Digits = "5678"
                        });
                });
            ...
            modelBuilder.Entity("EFCoreCinemaAPI.Models.PaypalPay", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 3,
                            Amount = 99.99m,
                            TransactionDate = new DateTime(2025, 7, 1, 13, 50, 47, 629, DateTimeKind.Local).AddTicks(9405),
                            Type = 2,
                        ...
                        new
                        {
                            Id = 4,
                            Amount = 49.99m,
                            TransactionDate = new DateTime(2025, 7, 2, 8, 50, 47, 629, DateTimeKind.Local).AddTicks(9433),
                            Type = 2,
                            Email = "leomarqz@gmail.com"
                        });
                });
