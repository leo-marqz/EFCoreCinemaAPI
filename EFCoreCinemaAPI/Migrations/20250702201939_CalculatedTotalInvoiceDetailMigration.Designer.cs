...
namespace EFCoreCinemaAPI.Migrations
{
    ...
    [Migration("20250702201939_CalculatedTotalInvoiceDetailMigration")]
    partial class CalculatedTotalInvoiceDetailMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EFCoreCinemaAPI.Models.Invoice", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 3,
                            TransactionDate = new DateTime(2025, 7, 2, 14, 19, 38, 708, DateTimeKind.Local).AddTicks(4745)
                        });
                });
            ...
            modelBuilder.Entity("EFCoreCinemaAPI.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amount = 9.99m,
                            TransactionDate = new DateTime(2025, 7, 1, 14, 19, 38, 718, DateTimeKind.Local).AddTicks(3877),
                            Type = 0
                        },
                        new
                        {
                            Id = 2,
                            Amount = 19.99m,
                            TransactionDate = new DateTime(2025, 7, 2, 4, 19, 38, 718, DateTimeKind.Local).AddTicks(3898),
                            Type = 0
                        });
                });
            ...
            modelBuilder.Entity("EFCoreCinemaAPI.Models.CardPay", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 5,
                            Amount = 79.99m,
                            TransactionDate = new DateTime(2025, 6, 30, 14, 19, 38, 710, DateTimeKind.Local).AddTicks(6433),
                            Type = 1,
                            Digits = "1234"
                        },
                        new
                        {
                            Id = 6,
                            Amount = 29.99m,
                            TransactionDate = new DateTime(2025, 7, 2, 11, 19, 38, 710, DateTimeKind.Local).AddTicks(6451),
                            Type = 1,
                            Digits = "5678"
                        });
                });
            ...
            modelBuilder.Entity("EFCoreCinemaAPI.Models.PaypalPay", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 3,
                            Amount = 99.99m,
                            TransactionDate = new DateTime(2025, 7, 1, 14, 19, 38, 718, DateTimeKind.Local).AddTicks(6983),
                            Type = 2,
                        ...
                        new
                        {
                            Id = 4,
                            Amount = 49.99m,
                            TransactionDate = new DateTime(2025, 7, 2, 9, 19, 38, 718, DateTimeKind.Local).AddTicks(6993),
                            Type = 2,
                            Email = "leomarqz@gmail.com"
                        });
                });
