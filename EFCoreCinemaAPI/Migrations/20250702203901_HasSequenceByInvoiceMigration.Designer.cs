...
namespace EFCoreCinemaAPI.Migrations
{
    ...
    [Migration("20250702203901_HasSequenceByInvoiceMigration")]
    partial class HasSequenceByInvoiceMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EFCoreCinemaAPI.Models.Invoice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 3,
                            InvoiceNumber = 0,
                            TransactionDate = new DateTime(2025, 7, 2, 14, 39, 0, 859, DateTimeKind.Local).AddTicks(8170)
                        });
                });
            ...
            modelBuilder.Entity("EFCoreCinemaAPI.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amount = 9.99m,
                            TransactionDate = new DateTime(2025, 7, 1, 14, 39, 0, 877, DateTimeKind.Local).AddTicks(5505),
                            Type = 0
                        },
                        new
                        {
                            Id = 2,
                            Amount = 19.99m,
                            TransactionDate = new DateTime(2025, 7, 2, 4, 39, 0, 877, DateTimeKind.Local).AddTicks(5525),
                            Type = 0
                        });
                });
            ...
            modelBuilder.Entity("EFCoreCinemaAPI.Models.CardPay", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 5,
                            Amount = 79.99m,
                            TransactionDate = new DateTime(2025, 6, 30, 14, 39, 0, 862, DateTimeKind.Local).AddTicks(6800),
                            Type = 1,
                            Digits = "1234"
                        },
                        new
                        {
                            Id = 6,
                            Amount = 29.99m,
                            TransactionDate = new DateTime(2025, 7, 2, 11, 39, 0, 862, DateTimeKind.Local).AddTicks(6825),
                            Type = 1,
                            Digits = "5678"
                        });
                });
            ...
            modelBuilder.Entity("EFCoreCinemaAPI.Models.PaypalPay", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 3,
                            Amount = 99.99m,
                            TransactionDate = new DateTime(2025, 7, 1, 14, 39, 0, 877, DateTimeKind.Local).AddTicks(9390),
                            Type = 2,
                        ...
                        new
                        {
                            Id = 4,
                            Amount = 49.99m,
                            TransactionDate = new DateTime(2025, 7, 2, 9, 39, 0, 877, DateTimeKind.Local).AddTicks(9410),
                            Type = 2,
                            Email = "leomarqz@gmail.com"
                        });
                });
