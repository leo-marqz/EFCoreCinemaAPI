...
namespace EFCoreCinemaAPI.Migrations
{
    ...
    [Migration("20250705023403_InvoiceVersionMigration")]
    partial class InvoiceVersionMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EFCoreCinemaAPI.Models.Invoice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 3,
                            InvoiceNumber = 0,
                            TransactionDate = new DateTime(2025, 7, 4, 20, 34, 2, 843, DateTimeKind.Local).AddTicks(8577)
                        });
                });
            ...
            modelBuilder.Entity("EFCoreCinemaAPI.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amount = 9.99m,
                            TransactionDate = new DateTime(2025, 7, 3, 20, 34, 2, 851, DateTimeKind.Local).AddTicks(3385),
                            Type = 0
                        },
                        new
                        {
                            Id = 2,
                            Amount = 19.99m,
                            TransactionDate = new DateTime(2025, 7, 4, 10, 34, 2, 851, DateTimeKind.Local).AddTicks(3405),
                            Type = 0
                        });
                });
            ...
            modelBuilder.Entity("EFCoreCinemaAPI.Models.CardPay", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 5,
                            Amount = 79.99m,
                            TransactionDate = new DateTime(2025, 7, 2, 20, 34, 2, 845, DateTimeKind.Local).AddTicks(8404),
                            Type = 1,
                            Digits = "1234"
                        },
                        new
                        {
                            Id = 6,
                            Amount = 29.99m,
                            TransactionDate = new DateTime(2025, 7, 4, 17, 34, 2, 845, DateTimeKind.Local).AddTicks(8425),
                            Type = 1,
                            Digits = "5678"
                        });
                });
            ...
            modelBuilder.Entity("EFCoreCinemaAPI.Models.PaypalPay", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 3,
                            Amount = 99.99m,
                            TransactionDate = new DateTime(2025, 7, 3, 20, 34, 2, 852, DateTimeKind.Local).AddTicks(1835),
                            Type = 2,
                        ...
                        new
                        {
                            Id = 4,
                            Amount = 49.99m,
                            TransactionDate = new DateTime(2025, 7, 4, 15, 34, 2, 852, DateTimeKind.Local).AddTicks(1852),
                            Type = 2,
                            Email = "leomarqz@gmail.com"
                        });
                });
