...
namespace EFCoreCinemaAPI.Migrations
{
    ...
    [Migration("20250705202348_GenreIsTemporalMigration")]
    partial class GenreIsTemporalMigration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EFCoreCinemaAPI.Models.CineOffer", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2025, 8, 4, 0, 0, 0, 0, DateTimeKind.Local),
            ...
            modelBuilder.Entity("EFCoreCinemaAPI.Models.Invoice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 3,
                            InvoiceNumber = 0,
                            TransactionDate = new DateTime(2025, 7, 5, 14, 23, 47, 501, DateTimeKind.Local).AddTicks(7750)
                        });
                });
            ...
            modelBuilder.Entity("EFCoreCinemaAPI.Models.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amount = 9.99m,
                            TransactionDate = new DateTime(2025, 7, 4, 14, 23, 47, 513, DateTimeKind.Local).AddTicks(1657),
                            Type = 0
                        },
                        new
                        {
                            Id = 2,
                            Amount = 19.99m,
                            TransactionDate = new DateTime(2025, 7, 5, 4, 23, 47, 513, DateTimeKind.Local).AddTicks(1680),
                            Type = 0
                        });
                });
            ...
            modelBuilder.Entity("EFCoreCinemaAPI.Models.CardPay", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 5,
                            Amount = 79.99m,
                            TransactionDate = new DateTime(2025, 7, 3, 14, 23, 47, 504, DateTimeKind.Local).AddTicks(7706),
                            Type = 1,
                            Digits = "1234"
                        },
                        new
                        {
                            Id = 6,
                            Amount = 29.99m,
                            TransactionDate = new DateTime(2025, 7, 5, 11, 23, 47, 504, DateTimeKind.Local).AddTicks(7734),
                            Type = 1,
                            Digits = "5678"
                        });
                });
            ...
            modelBuilder.Entity("EFCoreCinemaAPI.Models.PaypalPay", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 3,
                            Amount = 99.99m,
                            TransactionDate = new DateTime(2025, 7, 4, 14, 23, 47, 513, DateTimeKind.Local).AddTicks(4797),
                            Type = 2,
                        ...
                        new
                        {
                            Id = 4,
                            Amount = 49.99m,
                            TransactionDate = new DateTime(2025, 7, 5, 9, 23, 47, 513, DateTimeKind.Local).AddTicks(4805),
                            Type = 2,
                            Email = "leomarqz@gmail.com"
                        });
                });
